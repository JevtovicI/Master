...
//		  $scope.idLinija = linijaId;
//	        console.log(linijaId);
//	        $scope.novaLinija.id = linijaId;
//	        $http.put(baseUrlLi + "/" + linijaId).then(
//	                function success(res){
//	                	$scope.novaLinija.id = "";
//	                    $scope.novaLinija.brojMesta = res.data.brojMesta;
//	                	$scope.novaLinija.cenaKarte = res.data.cenaKarte;
//	                	$scope.novaLinija.vremePolaska = res.data.vremePolaska;
//	                	$scope.novaLinija.destinacija = res.data.destinacija;
//	                	$scope.novaLinija.prevoznikId = res.data.prevoznikId;
...
//		$scope.showEditButton = true;
		$http.get(baseUrlLi + "/" + linijaId).then(
				function success(res){
					$scope.novaLinija.brojMesta = res.data.brojMesta;
                	$scope.novaLinija.cenaKarte = res.data.cenaKarte;
                	$scope.novaLinija.vremePolaska = res.data.vremePolaska;
